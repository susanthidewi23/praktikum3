...
if (isset($_POST['submit'])) {
    ...
    $update = mysqli_query($conn, "UPDATE tb_matakuliah SET matakuliah_nama = '".$nama."' WHERE matakuliah_id = '".$m->matakuliah_id."'");
    if ($update) {
    ...
    <div class="container">
        ...
        <div class="box">
            <form action="" method="POST">
                <input type="text" name="nama" placeholder="Nama Matakuliah" class="input-control" value="<?php echo $m->matakuliah_nama ?>" required>
